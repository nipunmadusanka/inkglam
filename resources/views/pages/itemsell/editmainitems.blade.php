            ...
            <div class="flex bg-purple-200 rounded-full md:p-4 p-2 border-2 border-purple-300">
              <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                ...
                <div class="flex justify-center">
                    <div class="flex">
                        <h1 class="text-white font-bold md:text-2xl text-xl">Edit Main Item Category</h1>
                    </div>
                </div>
                <form action={{ Route('updatemainitem', ['id' => $result->id]) }} method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 mt-5 mx-7">
                        ...
                        <input
                            ...
                            type="text" name="name" value={{ $result->title }} placeholder={{ $result->title }} />
                        @error('name')
                    ...
                    <div class="grid grid-cols-1 mt-5 mx-7">
                        ...
                        <div class='flex justify-start w-full flex-col'>
                            <img src="{{ asset('itemMainCat/' . $result->image) }}" alt="image" class="w-16 mb-2" />
