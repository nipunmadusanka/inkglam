<x-app-layout>
    @if (Auth::user()->user_type == 0)
        <div class="flex h-auto items-center justify-center mt-15 mb-15">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 rounded-lg shadow-xl container">
            ...
            <div class="flex bg-purple-200 rounded-full md:p-4 p-2 border-2 border-purple-300">
              <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                ...
                <div class=" border-r border-white">
                    ...
                    <div class=" py-6 m-5 border-b-2 border-black">
                        <form action={{ Route('updateemployee', ['id' => $result->id]) }} method="POST"
                            ...
                            <div class="grid grid-cols-1 mt-5 mx-7">
                                <label
                                    class="uppercase md:text-sm text-xs text-white text-light font-semibold mb-1">Upload
                                    Photo</label>
                            ...
                            <div class='flex items-satart justify-start  md:gap-8 gap-4 pt-5 pb-5 mt-5 mx-7'>
                                {{-- <button
                        class='w-auto bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Cancel</button> --}}
                                <button type="submit"
                                    class='w-full bg-amber-500 hover:bg-amber-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Update</button>
                            </div>
                        </form>
                    </div>

                    <div class=" py-6 m-5 border-b-2 border-black">
                        @include('pages.employee.add_education_experience.education');
                    </div>
                    <div class=" py-6 m-5 border-b-2 border-black">
                        @include('pages.employee.add_education_experience.experience');
                    </div>
                </div>
