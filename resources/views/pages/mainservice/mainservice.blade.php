<x-app-layout>
    @if (Auth::user()->user_type == 0)
        <div class="p-4 flex flex-col">
            ...
            <div class="flex">
                <a href={{ Route('pages.viewaddnewservices') }}
                            ...
                            <tr
                                ...
                                <td
                                    ...
                                    <div class="flex flex-row items-center justify-center">
                                        <img src="{{ asset('mainservice/' . $item->image) }}" alt="image"
                                            class="w-16" />
                                    </div>
                                </td>
                                <td
                                ...
                                <td
                                    ...
                                    <div class="flex flex-row justify-center space-x-2">
                                        ...
                                        @endif
                                        <a href={{ Route('pages.viewsubproducts', ['id' => $item->id]) }} class="">
                                            <button
...
<script>
    $(document).ready(function() {
        $('.deactive').click(function(e) {
            ...
            if (deActiveId) {
                $.ajax({
                    url: '{{ route('mainservice.deactive') }}',
                    type: 'POST',
                    data: JSON.stringify({
