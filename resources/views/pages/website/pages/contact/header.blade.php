<div class="flex justify-center w-full h-full p-5 bg-slate-100">
    ...
    <div class="container flex items-center justify-center">
        <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] text-[#333] font-[sans-serif]">
            <div>
                <h1 class="text-3xl font-extrabold">Let's Talk</h1>
                <p class="text-sm text-gray-400 mt-3">Thank you for considering Ink & Glam Salon. We value your inquiries
                    and
