<div class=" bg-white">
    <div class="p-8 flex justify-center w-full h-full min-h-screen">
        {{-- <div class="flex justify-center w-full h-full p-5 bg-slate-100">
        <div class=""> --}}
        <div class="container flex items-center justify-center">
            <div class="grid grid-cols-1 lg:grid-cols-5">
                <div class="items-center mx-auto order-1 font-[sans-serif] col-span-2">
                    <img class=" bg-cover w-auto object-cover h-full" src={{ asset('map.png') }} />
                </div>
                <div
                    class="grid col-span-3 order-2 sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] text-[#333] font-[sans-serif]">
                    <div>
                        <h1 class="text-3xl font-extrabold">Let's Talk</h1>
                        <p class="text-sm text-gray-400 mt-3">Thank you for considering Ink & Glam Salon. We value your
                            inquiries
                            and
                            feedback. Feel free to reach out to us through the following channels:</p>
                        <div class="mt-12">
                            ...
                            <ul class="mt-3">
                                <li class="flex items-center">
                                    ...
                                    <a target="blank" href="#" class="text-[#007bff] text-sm ml-3">
                                        ...
                                        <strong>ink&glam@gmail.com</strong>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <form action={{ Route('letstalk') }} method="post" id="contactform" class="ml-auo space-y-4"
                        ...
                        <button type='button' type="submit"
                            class="contact-submit-btn text-white bg-[#007bff] hover:bg-blue-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full">Send</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        $('.contact-submit-btn').click(function(e) {
            ...
            if (canSubmit) {
                ...
                // Validate each input field separately
                ...
                if (formValid) {
                    ...
                    $.ajax({
                        ...
                        complete: function() {
                            console.log('Your Contact Info was successfully submitted')
                            $('#alertDiv').show();
                            $('#alertP').text(
                                'Your Contact Info was successfully submitted');
                            setTimeout(function() {
                                $('#alertDiv').hide();
                            }, 10000);
                    ...
                    $('#alertP').text('Please fill in all fields and provide a valid email address.');
                    console.log('Please fill in all fields and provide a valid email address.');
                }
            } else {
                setTimeout(function() {
                    $('#alertDiv').hide();
                ...
                $('#alertDiv').show();
                $('#alertP').text('Cannot submit within 1 minute. Please wait.');
                console.log('Cannot submit within 1 minute. Please wait.');
            }
        });
    });
</script>
