...
<div class="relative w-full glide-09 py-8 overflow-hidden">
    ...
    <div data-glide-el="track">
        <ul class="whitespace-no-wrap gap-2 flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden">
            <li>
