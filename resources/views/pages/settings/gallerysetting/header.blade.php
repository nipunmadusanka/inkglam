<div class="flex h-auto  items-center justify-center  mt-15 mb-15">
    <div class="grid rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
        ...
        <div class="flex justify-center">
            <div class="flex">
                <h1 class="text-white font-bold md:text-2xl text-xl">Add Gallery Images</h1>
            </div>
        </div>
        <form action={{ Route('addgalleryimage') }} method="POST" enctype="multipart/form-data">
            ...
            class='w-auto bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Cancel</button> --}}
                <button type="submit" onclick="validateForm()"
                    class='w-auto bg-purple-500 hover:bg-purple-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Upload</button>
            </div>
        </form>
    </div>
</div>
